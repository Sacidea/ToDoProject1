<!doctype html>
<!--burada başka sayfalara geçsek bile daima dörünecek sabit html elemanları bulunur--> 
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">ToDo</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
              <a href="javascript:void(0);" class="menu-link ">
                ...
                <div class="text-truncate" data-i18n="Dashboards">Ana Sayfa</div>
           ...
           <!-- <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{route('panel.categoryindex')}}" class="menu-link">
                ...
                <div class="text-truncate" data-i18n="Basic">Kategoriler</div>
              </a>
            </li>
            <!-- User interface -->
            <li class="menu-item">
              <a href="{{route('panel.indexTask')}}" class="menu-link ">
                ...
                <div class="text-truncate" data-i18n="User interface">Tasklar</div>
              </a>
            ...
            <!-- Extended components -->
            <li class="menu-item">
              <a href="{{'http://127.0.0.1:8000/user/profile'}}" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-copy"></i>
                <div class="text-truncate" data-i18n="Extended UI">Profil </div>
              </a>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        <i class="icon-base bx bx-user icon-md me-3"></i><span></span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="#">
                        <i class="icon-base bx bx-cog icon-md me-3"></i><span></span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="#">
